# Clemson ECE 4950: Senior Design 1, Spring 26

**Collaborative space for group 1**

- ***Core*** contains the main matlab script to run the game, motor model, and related device drivers
